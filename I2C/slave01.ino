...
void setup() {
  ...
  Serial.begin(115200);
  Wire.begin(1);  // master is optional to have an integer <= 127
 
  // next line only for slave cores
...
void loop() {
  ...
  // important following line shows graph
...
// slave write to master on I2C wires
void requestEvent(){

  // respond with message of ? bytes
  // as expected by master
  //String myReply = "I am one, sin(" +String(myX)+ ") = \t predicted: " + String(myAnswer);
  Wire.write( "I am one .." );
  //Wire.print("I am three ");
